...
# bot.comment_post('https://www.instagram.com/p/BXsotIigKI_/', 'awesome.. #cascais #portugal')
# bot.comment_multiple_posts([{'post': 'https://www.instagram.com/p/BXsotIigKI_/, 'comment': 'awesome..'}])
